...
if (isset($_SESSION['client_id'])) {
    ...
    $sql = "SELECT t2.id, t2.transactionNo, t2.status, t5.username, t2.tax, t2.collectedAt, t1.month AS month, t2.tax,  t4.revenue
            ...
            LEFT JOIN tbl_users t5 ON t4.user_id = t5.user_id
            WHERE YEAR(t2.collectedAt) = :year AND t3.client_id = :client_id
