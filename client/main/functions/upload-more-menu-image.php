...
if (isset($_FILES['files']) && isset($_POST['client_id']) && isset($_POST['menu_id'])) {
    // Retrieve client_id and menu_id
    ...
    // Upload Location
    $upload_location = "../../../assets/img/other-menu-uploads/";
        ...
        if (isset($_FILES['files']['name'][$index]) && $_FILES['files']['name'][$index] != '') {
            ...
            if (in_array($ext, $valid_ext)) {
                ...
                if (move_uploaded_file($_FILES['files']['tmp_name'][$index], $path)) {
                    ...
                    $sql = "INSERT INTO tblclient_othermenus (client_id, uniq_id, menu_id, file_name) VALUES (:client_id, :uniq_id, :menu_id, :file_name)";
