...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $sql_select_image = "SELECT file_name FROM tblclient_othermenus WHERE uniq_id = :uniq_id";
        ...
        $sql_delete_menu = "DELETE FROM tblclient_othermenus WHERE uniq_id = :uniq_id";
