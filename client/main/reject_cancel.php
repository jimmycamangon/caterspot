            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Reject / Cancel Reservations</li>
                    </ol>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="form-group">
                                ...
                                <b>List of Reject / Cancel Reservations</b>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($reservations as $reservation): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($reservation['status'] == "Rejected" || $reservation['status'] == "Request for cancel") { ?>
                                                    <span class="badge bg-danger"><?php echo $reservation['status']; ?></span>
                                                <?php } else if ($reservation['status'] == "Request cancellation approved.") { ?>
                                                        <span class="badge bg-success"><?php echo $reservation['status']; ?></span>
                                                <?php } ?>
                                            </td>
                                            <td>
