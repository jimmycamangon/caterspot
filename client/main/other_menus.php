<?php
include_once 'functions/fetch-other-menus.php';
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Other Menu Image</li>
                    </ol>
                        ...
                        <div class="card-header">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn-get-main" data-toggle="modal"
                                    ...
                                    <i class="fa-solid fa-plus"></i> Upload Additional Menu Images
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple" class="table">
                                ...
                                <tbody>
                                    <?php foreach ($menus as $menu): ?>
                                        <tr>
                                            <td>
                                                <?php echo $menu['menu_name'] . ' [' . $menu['package_name'] . ']'; ?>
                                            </td>
                                            <td>
                                                <center><img
                                                        src="../../assets/img/other-menu-uploads/<?php echo $menu['file_name']; ?>"
                                            ...
                                            <td>
                                                <button class="btn-get-del" data-toggle="modal" data-target="#DeleteModal"
                                                    data-menu-id="<?php echo $menu['uniq_id'] ?>"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between">
                    <h5 class="modal-title" id="AddNewModalLabel">Upload Additional Menu Images</h5>
                    ...
                    <div class="row">
                        <form method='post' action='' enctype="multipart/form-data">
                            <div id="packageDropdownContainer" class="form-group">
                                <label for="menu_id">Browse menu for more images:</label>
                                <select class="form-control" id="menu_id" name="menu_id">
                                    <?php
                                    // Fetch menus from tbl_menus
                                    $sql = "SELECT A.menu_id, A.menu_name, B.package_name FROM tbl_menus AS A
                                    ...
                                    if ($menus) {
                                        foreach ($menus as $menu) {
                                            echo '<option value="' . $menu['menu_id'] . '">' . $menu['menu_name'] . ' [' . $menu['package_name'] . ']' . '</option>';
                                        }
                                    } else {
                                        echo '<option value="" disabled selected>No Menu available. Please create a menu first.</option>';
                                        echo '</select>';
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="files[]" class="form-control" id="files" accept="image/*" multiple>
                            </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col d-flex justify-content-end">
                            ...
                            <button id="submitButton" class="btn-get-main" style="width:100%;" type="submit">Upload
                                Files</button>
                        </div>
                    </div>
                    </form>
    ...
    <script src="functions/js/upload-other-menu-image.js"></script>
