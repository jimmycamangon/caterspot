            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Booked Reservations</li>
                    </ol>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <i class="fa-solid fa-bookmark"></i>&nbsp;
                                <b>List of Booked Reservations</b>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($reservations as $reservation): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($reservation['status'] == "Booked") { ?>
                                                    <span class="badge bg-primary"><?php echo $reservation['status']; ?></span>
                                                <?php } ?>
                                            </td>
                                            <td>
