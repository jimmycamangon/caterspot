function rejectApplication(client_id, remarks) {

    var submitBtn = document.getElementById("confirmReject");
    ...
    $.ajax({
        url: 'functions/reject-client.php',
        type: 'POST',
        data: { client_id: client_id, status: 'Rejected', remarks: remarks },
